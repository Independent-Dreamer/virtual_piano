...
for i in range(88):
    ...
    if i % 12 == 9:
        # Gb
        black_key_pos1[i] = (37 * (((i - 9) * 7 / 12) + 5)) + 21 + piano_key_offset
        black_key_pos2[i] = (37 * (((i - 9) * 7 / 12) + 5)) + 23 + piano_key_offset

    if i % 12 == 11:
        # Ab
        black_key_pos1[i] = (37 * (((i - 11) * 7 / 12) + 6)) + 24 + piano_key_offset
        black_key_pos2[i] = (37 * (((i - 11) * 7 / 12) + 6)) + 26 + piano_key_offset
...
for i in range(88):
    ...
    if i % 12 == 2:
        # B
        waterfall_pos1[i][0] = 10 + (37 * (((i - 2) * 7 / 12) + 1)) + piano_key_offset + waterfall_offset_white_key
        waterfall_pos2[i][0] = 11 + (37 * (((i - 2) * 7 / 12) + 1)) + piano_key_offset + waterfall_offset_white_key
        waterfall_pos1[i][1] = white_key_waterfall_width
        waterfall_pos2[i][1] = white_key_waterfall_width - 2
    ...
    if i % 12 == 8:
        # F
        waterfall_pos1[i][0] = 1 + (37 * (((i - 8) * 7 / 12) + 5)) + piano_key_offset + waterfall_offset_white_key
        waterfall_pos2[i][0] = 2 + (37 * (((i - 8) * 7 / 12) + 5)) + piano_key_offset + waterfall_offset_white_key
        waterfall_pos1[i][1] = white_key_waterfall_width
        waterfall_pos2[i][1] = white_key_waterfall_width - 2

    if i % 12 == 10:
        # G
        waterfall_pos1[i][0] = 4 + (37 * (((i - 10) * 7 / 12) + 6)) + piano_key_offset + waterfall_offset_white_key
        waterfall_pos2[i][0] = 5 + (37 * (((i - 10) * 7 / 12) + 6)) + piano_key_offset + waterfall_offset_white_key
        waterfall_pos1[i][1] = white_key_waterfall_width
        waterfall_pos2[i][1] = white_key_waterfall_width - 2
    ...
    if i % 12 == 9:
        # Gb
        waterfall_pos1[i][0] = 7 + (37 * (((i - 9) * 7 / 12) + 5)) + 14 + piano_key_offset + waterfall_offset_black_key
        waterfall_pos2[i][0] = 8 + (37 * (((i - 9) * 7 / 12) + 5)) + 14 + piano_key_offset + waterfall_offset_black_key
        waterfall_pos1[i][1] = black_key_waterfall_width
        waterfall_pos2[i][1] = black_key_waterfall_width - 2

    if i % 12 == 11:
        # Ab
        waterfall_pos1[i][0] = 8 + (37 * (((i - 11) * 7 / 12) + 6)) + 16 + piano_key_offset + waterfall_offset_black_key
        waterfall_pos2[i][0] = 9 + (37 * (((i - 11) * 7 / 12) + 6)) + 16 + piano_key_offset + waterfall_offset_black_key
        waterfall_pos1[i][1] = black_key_waterfall_width
        waterfall_pos2[i][1] = black_key_waterfall_width - 2
...
while True:
    ...
    # print piano keys
    for i in range(52):
        pygame.draw.rect(screen, 'white', (white_key_pos[white_key_reflect[i]], global_resolution_y - 200, 34, 200), 0)
    for i in key_note:
        if white_key_or_not[i] == 1:
            pygame.draw.rect(screen, WKcol, (white_key_pos[i] + 0, global_resolution_y - 200, 34, 200), 0)
    for h in on_sustain:
        i = h - 21
        if white_key_or_not[i] == 1:
            pygame.draw.rect(screen, WKcol_on_sus, (white_key_pos[i] + 0, global_resolution_y - 200, 34, 200), 0)
    for i in range(36):
        pygame.draw.rect(screen, 'black', (black_key_pos1[black_key_reflect[i]] + 1, global_resolution_y - 200, 20, 130), 0)
        pygame.draw.rect(screen, (75, 75, 75),
                         (black_key_pos2[black_key_reflect[i]] + 2, global_resolution_y - 200, 14, 120), 0)
    for i in key_note:
        if white_key_or_not[i] == 0:
            pygame.draw.rect(screen, (105, 110, 175), (black_key_pos1[i] + 1, global_resolution_y - 200, 20, 130), 0)
            pygame.draw.rect(screen, BKcol, (black_key_pos2[i] + 2, global_resolution_y - 200, 14, 120), 0)
    for h in on_sustain:
        i = h - 21
        if white_key_or_not[i] == 0:
            pygame.draw.rect(screen, (105, 110, 175), (black_key_pos1[i] + 1, global_resolution_y - 200, 20, 130), 0)
            pygame.draw.rect(screen, BKcol_on_sus, (black_key_pos2[i] + 2, global_resolution_y - 200, 14, 120), 0)
    ...
    # 显示文字内容
    screen.blit(sustain_label, (global_resolution_x - 310, 18))
    screen.blit(sustain_state, (global_resolution_x - 57, 23))
    screen.blit(major_key_print, (46, 18))
    screen.blit(speed_print, ((global_resolution_x / 2) - 120, 18))
    screen.blit(tonicization_print, (270 + font_distance[major_key], 25))
